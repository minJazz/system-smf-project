				...
				<div class="page-content">
					...
					<div class="row">
						<div class="col-12">
							<div
								...
								<h4 class="page-title mb-0 font-size-18">사용자 수정</h4>
							</div>
						</div>
					</div>
					<!-- end page title -->
					...
					<div class="row">
						...
						<div class="col-xl-8" style="float: center;">
							<form:form class="custom-validation" action="/user" method="PUT">
								<div class="card">
									<div class="card-body">
											...
											<div class="mb-3 row">
												...
												<div class="col-md-10">
													<input class="form-control" data-parsley-type="number"
														...
														name="phoneNumber" value="${ serviceUser.phoneNumber }" />
												</div>
											</div>
												...
												<div class="col-md-10">
													...
													<div class="mt-2">
														<input type="password" class="form-control" required
															data-parsley-equalto="#pass2" data-parsley-length="[8,16]"
											...
											<div class="mb-3 row">
												...
												<div class="col-md-10">
													<input type="email" class="form-control" required
														...
														name="mail" value="${ serviceUser.mail }"/>
												</div>
											</div>
								...
								<a href="/user"><button type="button" style="float: right;"
									class="btn btn-secondary waves-effect">목록</button></a>
