...
<body data-layout="horizontal">
				...
				<div class="page-content">
					...
					<div class="row">
						<div class="col-xl-12">
							<div class="card">
								<div class="card-body">
									<input type="hidden" id="phoneNumber" value="${agentUser.phoneNumber}" /> 
									<p class="card-title-desc">
									<a style="float: right;"><button
											type="button"
											class="btn btn-outline-dark waves-effect waves-light"
											onclick="deleteClick()">Delete</button></a>
									</p>
									<br />
	...
	<script type="text/javascript">
										...
										function rendering(data) {
											...
											document
													.getElementById("pageTable").innerHTML = data[0].agentName;
										}
									</script>
